...
namespace vMenuClient.menus
{
    public class About
    {
        ...
        {
            // Create the menu.
            menu = new Menu("vMenu", "About SDvMenu");
            ...
            var credits = new MenuItem("About vMenu / Credits", "SDvMenu is made by ~h~Syrion~s~. For more info, checkout ~b~www.vespura.com/vmenu~s~. Thank you to: Deltanic, Brigliar, IllusiveTea, Shayan Doust, zr0iq and Golden for your contributions!");
